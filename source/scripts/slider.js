const sliderForm = document.querySelector('.slider-compare');

if (sliderForm) {
  const sliderButton = document.querySelector('.slider-compare__scrubber');
  const sliderBefore = document.querySelector('.slider-compare__image--before');
  const sliderAfter = document.querySelector('.slider-compare__image--after');
